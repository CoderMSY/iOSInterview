...
@interface MSYKVOListViewController ()

@property (nonatomic, strong) MSYCommonTableView *listView;

@end

@implementation MSYKVOListViewController
...
- (void)loadDataSource {
    ...
    for (NSInteger i = 0; i < 30; i++) {
        ...
        NSDictionary *rowDic = @{
            ...
            kRow_extraInfo : num,
            kRow_cellClass : NSStringFromClass([MSYKVOListCell class])
        };
